...
function Dashboard() {
    ...
    return (
        <div className='flex justify-between w-full'>
            <div className="left basis-4/12 grow-1 shrink-1 ">
                <div className="card shadow-md border border-gray-100 p-2">
                    <img src="https://png.pngitem.com/pimgs/s/43-434027_product-beauty-skin-care-personal-care-liquid-tree.png" alt="" />
                    <h4 className='p-1 text-xl font-bold'><h4 className='text-lg font-bold'>{randomVideo.title}</h4></h4>
                    ...
                    <p className='p-2'>Lorem ipsum dolor Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo, non. sit amet consectetur, adipisicing elit. Aut, odio?</p>
                </div>
                <hr />
            ...
            <div className="right basis-8/12 grow-1 shrink-1 ">
                <div className="right basis-8/12 grow-1 shrink-1  px-2">

                    <iframe
                        width="100%"
                        height="490"
                        src={`https://www.youtube.com/embed/${randomVideo.url}?autoplay=1&mute=1&controls=0&modestbranding=1&iv_load_policy=3&enablejsapi=1&origin=http://example.com`}
